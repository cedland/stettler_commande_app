...
class InfoRemarkScreen extends StatefulWidget {
  const InfoRemarkScreen({super.key, required this.customer});
  final CustomerModel customer;

  @override
  State<InfoRemarkScreen> createState() => _InfoRemarkScreenState();
}

class _InfoRemarkScreenState extends State<InfoRemarkScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Remarques",style: TextStyle(fontSize: 16,color: Colors.white,fontFamily: "LatoBold")),
      ),
      body: Padding(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Remarque du client contenant les données exactes.",
